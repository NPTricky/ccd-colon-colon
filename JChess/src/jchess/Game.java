...
public class Game extends JPanel implements MouseListener, ComponentListener
{
    ...
    {
        //log.debug("getValue called with: "+line);
    ...
    public void newGame()
    {
        ...
        //log.debug("new game, game type: "+settings.gameType.name());
    ...
    public void nextMove()
    {
        ...
        log.debug("next move, active player: " + activePlayer.name + ", color: " + activePlayer.color.name() + ", type: " + activePlayer.playerType.name());
        if (activePlayer.playerType == Player.playerTypes.localUser)
        {
            this.blockedChessboard = false;
        }
