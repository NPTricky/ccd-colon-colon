...
public class World {
     ...
     */
    public <T extends Component> ComponentMapper<T> getMapper(
            final Class<T> type) {
            ...
            try {
                ...
                for (final Field field : clazz.getDeclaredFields()) {
                    ...
                    if (annotation != null
                        ...
                        final ParameterizedType genericType = (ParameterizedType) field
                                .getGenericType();
                        final Type type = genericType.getActualTypeArguments()[0];
                        final Class<? extends Component> component = (Class<? extends Component>) type;

                        field.setAccessible(true);
                        field.set(target, world.getMapper(component));
                    }
                }
