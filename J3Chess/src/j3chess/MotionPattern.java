...
public class MotionPattern {
    ...
    /**
     * @brief whether the motion pattern is a jump or not
    ...
    /**
     * @brief constructor for an arbitrary number of motions.
     *        mask will default to EnumSet.allOf(PieceDirection.class)
     *        isJump will default to false
     * @param motions
     *            arbitrary number of motions which aggregates a motion pattern
     */
    public MotionPattern(final Motion... motions) {
        this(
                EnumSet.allOf(PieceDirection.class),
                false,
     ...
     *            the motion pattern direction mask
     * @param isJump
     *            whether the motion pattern is a jump or not
     *            (jumping is unblockable)
     *            (if true = jump over pieces)
     * @param motions
     *            arbitrary number of motions which aggregates a motion pattern
     ...
     * @return whether the motion pattern is a jump or not
     *         (jumping is unblockable)
     *         (if true = jump over pieces)
     */
     ...
     * @param isJump whether the motion pattern is a jump or not
     *               (jumping is unblockable)
     *               (if true = jump over pieces)
     */
