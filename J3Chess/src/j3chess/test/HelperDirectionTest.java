...
/**
 * This tests is for the direction helper. It Tests if all direction in the
 * right groups and if the Directions will be right converted from
 * pieceDirection to fieldDirection.
 */
public class HelperDirectionTest {
    ...
    public void directionFromGroupTest() {
        ...
        for (final PieceDirection direction : EnumSet
                .allOf(PieceDirection.class)) {
        ...
        assertEquals(testdirection.contains(PieceDirection.BackwardRight),
                false);
        assertEquals(testdirection.contains(PieceDirection.Forward), false);
    ...
    /**
     * @Brief checks if the PieceDirections are right converted to the
     *        FieldDirections
     */
    @Test
    public void toFieldDirectionTest() {
        final Boolean crossedCenter = false;

        assertEquals(Helper.Direction.toFieldDirection(PieceDirection.Backward,
                crossedCenter), FieldDirection.Out);
        ...
        assertEquals(Helper.Direction.toFieldDirection(PieceDirection.Forward,
                crossedCenter), FieldDirection.In);
        assertEquals(Helper.Direction.toFieldDirection(
        ...
        assertEquals(Helper.Direction.toFieldDirection(PieceDirection.Left,
                crossedCenter), FieldDirection.Clockwise);
        assertEquals(Helper.Direction.toFieldDirection(PieceDirection.Right,
                crossedCenter), FieldDirection.CounterClockwise);
    }
}
