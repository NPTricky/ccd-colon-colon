...
import j3chess.artemis.annotations.Mapper;
import j3chess.artemis.utils.Bag;
			...
			try {
				...
				for (Field field : clazz.getDeclaredFields()) {
					...
					if (annotation != null && Mapper.class.isAssignableFrom(Mapper.class)) {
						...
						Class<? extends Component> component = (Class<? extends Component>) type;
